...
app = dash.Dash(__name__
   #external_stylesheets="C:/Users/sagar/Documents/Project_SPP/assets/crio.css"
    #assets_external_path=["https://fonts.googleapis.com/css2?family=Roboto&display=swap"]
)
server = app.server
# html layout of site
app.layout = html.Div(
...
def update_data(n, val):  # inpur parameter(s)
    if n == None:
        return "Please enter a legitimate stock code to get details.",None,None, None, None, None
        # raise PreventUpdate
    else:
        if val == None:
            raise PreventUpdate
